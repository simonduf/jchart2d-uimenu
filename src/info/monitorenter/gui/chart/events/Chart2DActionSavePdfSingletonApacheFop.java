 ...
 *  singleton action that saves the chart to a pdf
 *  file.
...
/**
 * Singleton <code>Action</code> that saves the current chart to a pdf
 * file at the the location specified by showing a modal file chooser
 * save dialog.
 * <p>
 ...
 */
public final class Chart2DActionSavePdfSingletonApacheFop {
  ...
  private static class ActionDisabledDummy extends AbstractAction {
    ...
    private static final long serialVersionUID = 5537391176736852749L;
  ...
  /**
   * Implementation of the action that depends on xmlgraphic-commsns and must not be class
   * loaded in case the corresponding classes are missing in the classpath.
   */

  private static final class Chart2DActionSavePdf extends AChart2DAction {

    /** Generated <code>serialVersionUID</code>. */
    private static final long serialVersionUID = 4165725826047395415L;
     ...
     *          ).
     */
    public Chart2DActionSavePdf(final Chart2D chart, final String colorName) {
    ...
    public void actionPerformed(final ActionEvent e) {
      ...
      if (ret == JFileChooser.APPROVE_OPTION) {
        ...
        try {
          ...
          PDFDocumentGraphics2D g2d = new PDFDocumentGraphics2D(true);
  ...
  /** Flag set whenever the proper jar file (fop) is in the classpath. */
  public static final boolean PDF_SUPPORTED;
  ...
  static {
    ...
    try {
      ...
      test = Class.forName("org.apache.fop.svg.PDFDocumentGraphics2D");
      test = Class.forName("org.apache.commons.logging.LogFactory");
      test = Class.forName("org.apache.commons.io.output.CountingOutputStream");
      test = Class.forName("org.apache.batik.ext.awt.RenderingHintsKeyExt");
      test = Class.forName("org.apache.avalon.framework.CascadingRuntimeException");
  ...
  public static Action getInstance(final Chart2D chart, final String actionName) {
    Action result = Chart2DActionSavePdfSingletonApacheFop.instances.get(Chart2DActionSavePdfSingletonApacheFop
        .key(chart));
    if (result == null) {
      if (Chart2DActionSavePdfSingletonApacheFop.PDF_SUPPORTED) {
        result = new Chart2DActionSavePdf(chart, actionName);
      } else {
        result = new ActionDisabledDummy(actionName);
      }
      Chart2DActionSavePdfSingletonApacheFop.instances.put(Chart2DActionSavePdfSingletonApacheFop.key(chart), result);
    }
    return result;
  }
   ...
   * <p>
   */
  private Chart2DActionSavePdfSingletonApacheFop() {
    // nop
  }
}
