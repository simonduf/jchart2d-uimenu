/*
 * LayoutFactory.java jchart2d, factory for creating user interface controls for
 * charts and traces. Copyright (c) 2007 - 2013 Achim Westermann, created on
 * 09:50:20.
 * 
...
import info.monitorenter.gui.chart.events.Chart2DActionSavePdfSingletonApacheFop;
...
public final class LayoutFactory {
  ...
  public static class BasicPropertyAdaptSupport implements PropertyChangeListener {
    ...
    public static class RemoveAsListenerFromComponentIfTraceIsDropped implements IRemoveAsListenerFromComponentCondition {
      ...
      static {
        PROPERTIES_SENT_BY_CHART2D_TO_REMOVE_BASICPROPERTYADAPTSUPPORT_AS_LISTENER_ON_CHART.add(Chart2D.PROPERTY_ADD_REMOVE_TRACE);
      }
      ...
      public boolean isRemoveMeAsListenerComponentEvent(PropertyChangeEvent event) {
        ...
        if (PROPERTIES_SENT_BY_CHART2D_TO_REMOVE_BASICPROPERTYADAPTSUPPORT_AS_LISTENER_ON_CHART.contains(property)) {
  ...
  private static class OrderingCheckBoxMenuItem extends JCheckBoxMenuItem {
    ...
    private final class JMenuOrderingAction extends AbstractAction {
      ...
      public void actionPerformed(final ActionEvent e) {
        ...
        if (state) {
          LayoutFactory.OrderingCheckBoxMenuItem.this.m_menu.remove(LayoutFactory.OrderingCheckBoxMenuItem.this);
          LayoutFactory.OrderingCheckBoxMenuItem.this.m_menu.add(LayoutFactory.OrderingCheckBoxMenuItem.this, 0);
        } else {
          LayoutFactory.OrderingCheckBoxMenuItem.this.m_menu.remove(LayoutFactory.OrderingCheckBoxMenuItem.this);
          LayoutFactory.OrderingCheckBoxMenuItem.this.m_menu.add(LayoutFactory.OrderingCheckBoxMenuItem.this);
        }
      }
     ...
     */
    public OrderingCheckBoxMenuItem(final Action action, final JMenu container, final boolean checked) {
      super();
   ...
   * <p>
   */
  private static class OrderingCheckBoxPropertyChangeMenuItem extends LayoutFactory.OrderingCheckBoxMenuItem {
     ...
     * @see LayoutFactory.PropertyChangeCheckBoxMenuItem
     */
    public OrderingCheckBoxPropertyChangeMenuItem(final JComponent component, final Action action, final JMenu container, final boolean checked,
  ...
  public static class PropertyChangeCheckBoxMenuItem extends JCheckBoxMenuItem {
     ...
     *          for basic property changes.
     */
    public PropertyChangeCheckBoxMenuItem(final JComponent component, final Action action, final boolean checked,
  ...
  private static class PropertyChangeJRadioButtonMenuItem extends JRadioButtonMenuItem {
     ...
     *          for basic property changes.
     */
    public PropertyChangeJRadioButtonMenuItem(final JComponent component, final Action action, final boolean selected,
        BasicPropertyAdaptSupport.IRemoveAsListenerFromComponentCondition quitListeningOnBasicPropertyChangesControl) {
      // invokes setAction
      super(action);
  ...
  final class TraceJLabel extends JLabel implements PropertyChangeListener {
    ...
    public TraceJLabel(final ITrace2D trace) {
      ...
      new BasicPropertyAdaptSupport(this, trace.getRenderer(), new LayoutFactory.BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    }
  ...
  /** Boolean flag that controls showing the save to pdf menu item. */
  private boolean m_showSavePdfMenu = true;
  ...
  private LayoutFactory() {
    ...
    this.m_strokes[2] = new BasicStroke(6, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10.0f, new float[] {0, 10f }, 0f);
    this.m_strokeNames[2] = "round caps";
    this.m_strokes[3] = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 1.5f, new float[] {5f, 5f }, 2.5f);
    this.m_strokeNames[3] = "dashed";
    this.m_strokes[4] = new BasicStroke(6, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_ROUND, 10.0f, new float[] {0, 10f }, 0f);
    this.m_strokeNames[4] = "square caps";
    this.m_strokes[5] = new BasicStroke(3, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1.5f, new float[] {10f, 2f }, 1f);
  ...
  public JMenu createAnnoationsMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      ...
      item = new PropertyChangeMenuItem(chart, new ChartPanelActionAddAnnotation(chartPanel, "Annotation 1"),
  ...
  private Component createAxisFormatterMenu(Chart2D chart, IAxis< ? > axis, int axisDimension, boolean adaptUI2Chart) {
    ...
    JMenu numberMenu;
    if (adaptUI2Chart) {
      numberMenu = new PropertyChangeMenu(chart, "Numbers", BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
   ...
   *         {@link info.monitorenter.gui.chart.axis.AAxis} features.
   */
  public JMenuItem createAxisMenuItem(final IAxis< ? > axis, final int axisDimension, final boolean adaptUI2Chart) {
    ...
    if ((this.m_showAxisXTypeMenu && axisDimension == Chart2D.X) || (this.m_showAxisYTypeMenu && axisDimension == Chart2D.Y)) {
    ...
    if ((this.m_showAxisXRangePolicyMenu && axisDimension == Chart2D.X) || this.m_showAxisYRangePolicyMenu && axisDimension == Chart2D.Y) {
      axisMenuItem.add(this.createAxisRangePolicyMenu(chart, axis, adaptUI2Chart));

      // Axis -> Range menu
      if (adaptUI2Chart) {

        item = new PropertyChangeMenuItem(chart, new AxisActionSetRange(chart, "Range", axisDimension),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
    ...
    if ((this.m_showAxisXTitleMenu && axisDimension == Chart2D.X) || (this.m_showAxisYTitleMenu && axisDimension == Chart2D.Y)) {
   ...
   */
  public JMenu createAxisRangePolicyMenu(final Chart2D chart, final IAxis< ? > axis, final boolean adaptUI2Chart) {
    JMenuItem item;
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new AxisActionSetRangePolicy(chart, "Fixed viewport", axis.getDimension(),
          new RangePolicyFixedViewport()), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new AxisActionSetRangePolicy(chart, "Fixed viewport", axis.getDimension(), new RangePolicyFixedViewport()),
          selected);
    }
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new AxisActionSetRangePolicy(chart, "Minimum viewport", axis.getDimension(),
          new RangePolicyUnbounded()), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new AxisActionSetRangePolicy(chart, "Minimum viewport", axis.getDimension(), new RangePolicyUnbounded()),
          selected);
    }
    axisRangePolicy.add(item);
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new AxisActionSetRangePolicy(chart, "Minimum viewport with range", axis.getDimension(),
          new RangePolicyMinimumViewport(new Range(10, 10))), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new AxisActionSetRangePolicy(chart, "Minimum viewport with range", axis.getDimension(),
          new RangePolicyMinimumViewport(new Range(10, 10))), selected);
    }
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new AxisActionSetRangePolicy(chart, "Ensure visible point", axis.getDimension(),
          new RangePolicyForcedPoint(0)), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new AxisActionSetRangePolicy(chart, "Ensure visible point", axis.getDimension(),
          new RangePolicyForcedPoint(0)), selected);
    }
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new AxisActionSetRangePolicy(chart, "Highest points within max-50 to max.", axis.getDimension(),
          new RangePolicyHighestValues(50)), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new AxisActionSetRangePolicy(chart, "Highest points within max-50 to max.", axis.getDimension(),
   ...
   */
  public JMenu createAxisTitleMenu(final Chart2D chart, final IAxis< ? > axis, final int axisDimension, final boolean adaptUI2Chart) {
    ...
    JMenuItem item;
    if (adaptUI2Chart) {
      item = new PropertyChangeMenuItem(chart, new AxisActionSetTitle(chart, "Title", axisDimension),
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
    ...
    for (int i = fonts.length - 1; i > -1; i--) {
      if (adaptUI2Chart) {
        item = new OrderingCheckBoxPropertyChangeMenuItem(chart, new AxisActionSetTitleFont(chart, fonts[i].getName(), axisDimension, fonts[i]), axisTitleFont,
            false, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
        item = new OrderingCheckBoxMenuItem(new AxisActionSetTitleFont(chart, fonts[i].getName(), axisDimension, fonts[i]), axisTitleFont, false);
      }
   ...
   *         <code>axisDimension</code>.
   */
  public JMenu createAxisTypeMenu(final Chart2D chart, final IAxis< ? > axis, final int axisDimension, final boolean adaptUI2Chart) {
    // Axis -> Axis type
    JMenu axisType;
    if (adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetAxis(chart, new AxisLinear<IAxisScalePolicy>(), "Linear", axisDimension),
          selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetAxis(chart, new AxisLinear<IAxisScalePolicy>(), "Linear", axisDimension), selected);
    }
    axisType.add(item);
    buttonGroup.add(item);
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetAxis(chart, new AxisLogE<AxisScalePolicyTransformation>(), "Log E",
          axisDimension), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetAxis(chart, new AxisLogE<AxisScalePolicyTransformation>(), "Log E", axisDimension),
          selected);
    }
    axisType.add(item);
    buttonGroup.add(item);
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetAxis(chart, new AxisLog10<AxisScalePolicyTransformation>(), "Log 10",
          axisDimension), selected, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetAxis(chart, new AxisLog10<AxisScalePolicyTransformation>(), "Log 10", axisDimension),
          selected);
    }
    axisType.add(item);
    buttonGroup.add(item);
  ...
  public JMenu createBackgroundColorMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetBackground(chart, "White", Color.WHITE), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetBackground(chart, "White", Color.WHITE), selected);
    }
    buttonGroup.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetBackground(chart, "Gray", Color.GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetBackground(chart, "Gray", Color.GRAY), selected);
    }
    buttonGroup.add(item);
    bgColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetBackground(chart, "Light gray", Color.LIGHT_GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetBackground(chart, "Light gray", Color.LIGHT_GRAY), selected);
    }
    buttonGroup.add(item);
    bgColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetBackground(chart, "Black", Color.BLACK), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetBackground(chart, "Black", Color.BLACK), selected);
    }

    buttonGroup.add(item);
    bgColorMenu.add(item);
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, JComponentActionSetCustomBackgroundSingleton.getInstance(chart, "Custom Color"), nonStandardColor,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(JComponentActionSetCustomBackgroundSingleton.getInstance(chart, "Custom Color"), nonStandardColor);
    }
    buttonGroup.add(item);
    bgColorMenu.add(item);
    return bgColorMenu;
  ...
  public JMenuItem createChartGridMenu(ChartPanel chartPanel, boolean adaptUI2Chart) {
    ...
    if (this.m_showAxisXGridMenu) {
      ...
      if (adaptUI2Chart) {
        item = new PropertyChangeCheckBoxMenuItem(chart, new AxisActionSetGrid(chart, "Grid X", Chart2D.X), chart.getAxisX().isPaintGrid(),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
        item = new SelectionAdaptJCheckBoxMenuItem(new AxisActionSetGrid(chart, "Grid X", Chart2D.X), chart.getAxisX().isPaintGrid());
      }
      gridMenu.add(item);
    }
    if (this.m_showAxisYGridMenu) {
      ...
      if (adaptUI2Chart) {
        item = new PropertyChangeCheckBoxMenuItem(chart, new AxisActionSetGrid(chart, "Grid Y", Chart2D.Y), chart.getAxisY().isPaintGrid(),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
        item = new SelectionAdaptJCheckBoxMenuItem(new AxisActionSetGrid(chart, "Grid Y", Chart2D.Y), chart.getAxisX().isPaintGrid());
      }
      gridMenu.add(item);
    }
    return gridMenu;
  ...
  public JMenuItem createChartHighlightMenu(ChartPanel chartPanel, boolean adaptUI2Chart) {
    ...
    JMenuItem item;
    if (adaptUI2Chart) {
      item = new PropertyChangeCheckBoxMenuItem(chart, new Chart2DActionEnableHighlighting(chart, "Enable"), isEnabledHighlighting,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionEnableHighlighting(chart, "Enable"), isEnabledHighlighting);
    }
  ...
  public JMenu createChartMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    if (this.m_showAntialiasingMenu) {
      ...
      if (adaptUI2Chart) {
        item = new PropertyChangeCheckBoxMenuItem(chart, new Chart2DActionEnableAntialiasing(chart, "Antialiasing"), chart.isUseAntialiasing(),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
        item = new SelectionAdaptJCheckBoxMenuItem(new Chart2DActionEnableAntialiasing(chart, "Antialiasing"), chart.isUseAntialiasing());
      }
    ...
    if (this.m_showPrintMenu) {
      if (adaptUI2Chart) {
        item = new PropertyChangeMenuItem(chart, Chart2DActionPrintSingleton.getInstance(chart, "Print chart"),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
    ...
    if (chart instanceof ZoomableChart && this.m_showZoomOutMenu) {
      if (adaptUI2Chart) {
        item = new PropertyChangeMenuItem(chart, new ZoomableChartZoomOutAction((ZoomableChart) chart, "Zoom Out"),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      } else {
  ...
  public JMenu createChartSetToolTipTypeMenu(ChartPanel chartPanel, boolean adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new ChartActionSetToolTipType(chart, type.getDescription(), type), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJCheckBoxMenuItem(new ChartActionSetToolTipType(chart, type.getDescription(), type), selected);
    }
    buttonGroup.add(item);
   ...
   */
  public JMenu createErrorBarWizardMenu(final Chart2D chart, final ITrace2D trace, final boolean adaptUI2Chart) {
    JMenuItem item;
    ...
    for (IErrorBarPolicy< ? > errorBarPolicy : errorBarPolicies) {
      if (adaptUI2Chart) {
        item = new PropertyChangeMenuItem(chart, new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy, errorBarAddMenu,
            errorBarRemoveMenu, erroBarEditMenu), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
      } else {
        item = new JMenuItem(new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy, errorBarAddMenu, errorBarRemoveMenu,
            erroBarEditMenu));
      }
    ...
    for (IErrorBarPolicy< ? > errorBarPolicy : addableErrorBarPolicies) {
      if (adaptUI2Chart) {
        errorBarAddMenu.add(new PropertyChangeMenuItem(chart, new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy,
            errorBarAddMenu, errorBarRemoveMenu, erroBarEditMenu), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace)));

      } else {
        errorBarAddMenu.add(new JMenuItem(new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy, errorBarAddMenu,
    ...
    for (IErrorBarPolicy< ? > errorBarPolicy : errorBarPolicies) {
      if (adaptUI2Chart) {
        errorBarRemoveMenu.add(new PropertyChangeMenuItem(chart, new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy,
            errorBarAddMenu, errorBarRemoveMenu, erroBarEditMenu), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace)));
      } else {
        errorBarRemoveMenu.add(new JMenuItem(new ErrorBarPolicyMultiAction(trace, errorBarPolicy.getClass().getName(), errorBarPolicy, errorBarAddMenu,
            errorBarRemoveMenu, erroBarEditMenu)));
      }
    }
   ...
   */
  public JMenuItem createForegroundColorMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetForeground(chart, "White", Color.WHITE), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetForeground(chart, "White", Color.WHITE), selected);
    }
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetForeground(chartPanel.getChart(), "Gray", Color.GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetForeground(chart, "Gray", Color.GRAY), selected);
    }
    buttonGroup.add(item);
    fgColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetForeground(chartPanel.getChart(), "Light gray", Color.LIGHT_GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());

    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetForeground(chart, "Light gray", Color.LIGHT_GRAY), selected);
    }
    buttonGroup.add(item);
    fgColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new JComponentActionSetForeground(chart, "Black", Color.BLACK), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new JComponentActionSetForeground(chart, "Black", Color.BLACK), selected);
    }
    buttonGroup.add(item);
    fgColorMenu.add(item);
    ...
    // kille
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chartPanel.getChart(), JComponentActionSetCustomForegroundSingleton.getInstance(chartPanel.getChart(),
          "Custom Color"), nonStandardColor, BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(JComponentActionSetCustomForegroundSingleton.getInstance(chartPanel.getChart(), "Custom Color"),
          nonStandardColor);
    }
    buttonGroup.add(item);
    fgColorMenu.add(item);
  ...
  public JMenu createGridColorMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetGridColor(chart, "Gray", Color.GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetGridColor(chart, "Gray", Color.GRAY), selected);
    }
    buttonGroup.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetGridColor(chart, "Light gray", Color.LIGHT_GRAY), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetGridColor(chart, "Light gray", Color.LIGHT_GRAY), selected);
    }
    buttonGroup.add(item);
    gridColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetGridColor(chart, "Black", Color.BLACK), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetGridColor(chart, "Black", Color.BLACK), selected);
    }
    buttonGroup.add(item);
    gridColorMenu.add(item);
    ...
    nonStandardColor &= !selected;
    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, new Chart2DActionSetGridColor(chart, "White", Color.WHITE), selected,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(new Chart2DActionSetGridColor(chart, "White", Color.WHITE), selected);
    }
    buttonGroup.add(item);
    gridColorMenu.add(item);

    if (adaptUI2Chart) {
      item = new PropertyChangeJRadioButtonMenuItem(chart, Chart2DActionSetCustomGridColorSingleton.getInstance(chart, "Custom"), nonStandardColor,
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
    } else {
      item = new SelectionAdaptJRadioButtonMenuItem(Chart2DActionSetCustomGridColorSingleton.getInstance(chart, "Custom"), nonStandardColor);
    }
    buttonGroup.add(item);
    gridColorMenu.add(item);
  ...
  public JMenu createSaveMenu(final ChartPanel chartPanel, final boolean adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      ...
      item = new PropertyChangeMenuItem(chart, Chart2DActionSaveImageSingleton.getInstance(chart, "Save image"),
          BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      result.add(item);
      if (this.m_showSaveEpsMenu) {
        item = new PropertyChangeMenuItem(chart, Chart2DActionSaveEpsSingletonApacheFop.getInstance(chart, "Save eps"),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
      ...
      if (this.m_showSavePdfMenu) {
        item = new PropertyChangeMenuItem(chart, Chart2DActionSavePdfSingletonApacheFop.getInstance(chart, "Save pdf"),
            BasicPropertyAdaptSupport.RemoveAsListenerFromComponentNever.getInstance());
        if (!Chart2DActionSavePdfSingletonApacheFop.PDF_SUPPORTED) {
          item.setToolTipText("This is disabled because at least one of the following files is missing on the classpath: fop-<version>.jar, commons-logging-<version>.jar, commons-io-<version>.jar, batik-all-<version>.jar, avalon-framework-<version>.jar.");
        }
        result.add(item);
      }
    } else {
      ...
      result.add(item);
      if (this.m_showSaveEpsMenu) {
        item = new JMenuItem(Chart2DActionSaveEpsSingletonApacheFop.getInstance(chart, "Save eps"));
        if (!Chart2DActionSaveEpsSingletonApacheFop.EPS_SUPPORTED) {
          item.setToolTipText("This is disabled as xmlgraphics-commons-<version>.jar is missing on the classpath.");
        }
        result.add(item);
      ...
      if (this.m_showSavePdfMenu) {
        item = new JMenuItem(Chart2DActionSavePdfSingletonApacheFop.getInstance(chart, "Save pdf"));
        if (!Chart2DActionSavePdfSingletonApacheFop.PDF_SUPPORTED) {
          item.setToolTipText("This is disabled because at least one of the following files is missing on the classpath: fop-<version>.jar, commons-logging-<version>.jar, commons-io-<version>.jar, batik-all-<version>.jar, avalon-framework-<version>.jar.");
        }
        result.add(item);
   ...
   */
  public JMenu createTraceColorMenu(final Chart2D chart, final ITrace2D trace, final JComponent parent, final boolean adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeMenuItem(chart, new Trace2DActionSetColor(trace, "Magenta", Color.MAGENTA),
          new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeMenuItem(chart, new Trace2DActionSetCustomColor(trace, "Custom", parent),
          new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
   ...
   */
  public JLabel createTraceContextMenuLabel(final Chart2D chart, final ITrace2D trace, final boolean adaptUI2Chart) {
    ...
    if (!StringUtil.isEmpty(traceLabel)) {
      ...
      if (this.m_showTraceVisibleMenu) {
        if (adaptUI2Chart) {
          item = new PropertyChangeCheckBoxMenuItem(chart, new Trace2DActionSetVisible(trace, "Visible"), trace.isVisible(),
              new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
        } else {
          item = new SelectionAdaptJCheckBoxMenuItem(new Trace2DActionSetVisible(trace, "Visible"), trace.isVisible());
        }
        popup.add(item);
      }
      ...
      if (this.m_showPhysicalUnitsMenu) {
        if (adaptUI2Chart) {
          item = new PropertyChangeMenuItem(chart, new Trace2DActionSetPhysicalUnits(trace, "Physical Units", chart),
              new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
        } else {
   ...
   *         the given trace.
   */
  private List<JMenuItem> createTraceHighlighterItems(final ITrace2D trace, final boolean adaptUI2Chart) {
    ...
    for (int i = 0; i < highlighters.length; i++) {
      ...
      if (adaptUI2Chart) {
        item = new PropertyChangeCheckBoxMenuItem(trace.getRenderer(), new Trace2DActionAddRemoveHighlighter(trace, highlighterNames[i], highlighter), false,
            new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
      } else {
        item = new SelectionAdaptJCheckBoxMenuItem(new Trace2DActionAddRemoveHighlighter(trace, highlighterNames[i], highlighter), false);
      }
      result.add(item);
    }
   ...
   */
  public JMenu createTracePainterMenu(final Chart2D chart, final ITrace2D trace, final boolean adaptUI2Chart) {
    JMenuItem item;
    // trace painters
    JMenu painterMenu;
    if (adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new OrderingCheckBoxPropertyChangeMenuItem(chart, new Trace2DActionAddRemoveTracePainter(trace, "discs", painter), painterMenu,
          trace.containsTracePainter(painter), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
      item = new OrderingCheckBoxMenuItem(new Trace2DActionAddRemoveTracePainter(trace, "discs", painter), painterMenu, trace.containsTracePainter(painter));
    }
    ...
    if (adaptUI2Chart) {
      item = new OrderingCheckBoxPropertyChangeMenuItem(chart, new Trace2DActionAddRemoveTracePainter(trace, "line", painter), painterMenu,
          trace.containsTracePainter(painter), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
      item = new OrderingCheckBoxMenuItem(new Trace2DActionAddRemoveTracePainter(trace, "line", painter), painterMenu, trace.containsTracePainter(painter));
    }
    painterMenu.add(item);

    painter = new TracePainterFill(chart);
    if (adaptUI2Chart) {
      item = new OrderingCheckBoxPropertyChangeMenuItem(chart, new Trace2DActionAddRemoveTracePainter(trace, "fill", painter), painterMenu,
          trace.containsTracePainter(painter), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
      item = new OrderingCheckBoxMenuItem(new Trace2DActionAddRemoveTracePainter(trace, "fill", painter), painterMenu, trace.containsTracePainter(painter));
    ...
    if (adaptUI2Chart) {
      item = new OrderingCheckBoxPropertyChangeMenuItem(chart, new Trace2DActionAddRemoveTracePainter(trace, "bar", painter), painterMenu,
          trace.containsTracePainter(painter), new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
      item = new OrderingCheckBoxMenuItem(new Trace2DActionAddRemoveTracePainter(trace, "bar", painter), painterMenu, trace.containsTracePainter(painter));
    }
    painterMenu.add(item);
   ...
   */
  public JMenu createTraceStrokesMenu(final Chart2D chart, final ITrace2D trace, final boolean adaptUI2Chart) {
    JMenuItem item;
    // strokes
    JMenu strokesMenu;
    if (adaptUI2Chart) {
    ...
    for (int i = 0; i < this.m_strokes.length; i++) {
      if (adaptUI2Chart) {
        item = new PropertyChangeMenuItem(chart, new Trace2DActionSetStroke(trace, this.m_strokeNames[i], this.m_strokes[i]),
            new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
      } else {
        item = new JMenuItem(new Trace2DActionSetStroke(trace, this.m_strokeNames[i], this.m_strokes[i]));
      }
   ...
   */
  public JMenu createTraceZindexMenu(final Chart2D chart, final ITrace2D trace, final boolean adaptUI2Chart) {
    JMenuItem item;
    // submenu for zIndex
    JMenu zIndexMenu;
    if (adaptUI2Chart) {
    ...
    if (adaptUI2Chart) {
      item = new PropertyChangeMenuItem(chart, new Trace2DActionSetZindex(trace, "send to back", ITrace2D.ZINDEX_MAX),
          new BasicPropertyAdaptSupport.RemoveAsListenerFromComponentIfTraceIsDropped(trace));
    } else {
  ...
  /**
   * Returns the showSavePdfMenu.
   * <p>
   * 
   * @return the showSavePdfMenu
   */
  public boolean isShowSavePdfMenu() {
    return this.m_showSavePdfMenu;
  }
  ...
  /**
   * Sets the showSavePdfMenu.
   * <p>
   * 
   * @param showSavePdfMenu
   *          the showSavePdfMenu to set
   */
  public void setShowSavePdfMenu(final boolean showSavePdfMenu) {
    this.m_showSavePdfMenu = showSavePdfMenu;
  }
